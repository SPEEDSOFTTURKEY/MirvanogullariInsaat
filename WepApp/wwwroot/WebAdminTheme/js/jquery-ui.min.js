...
! function(t) {
    ...
    x.cleanData = (n = x.cleanData, function(t) {
        ...
        var s, n, o, l = {},
            a = t.split(".")[0],
            r = a + "-" + (t = t.split(".")[1]);
        return e || (e = i, i = x.Widget), x.isArray(e) && (e = x.extend.apply(null, [{}].concat(e))), x.expr[":"][r.toLowerCase()] = function(t) {
            return !!x.data(t, r)
        ...
        x.fn[o] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                var t = x.data(this, l);
                t ? (t.option(i || {}), t._init && t._init()) : x.data(this, l, new e(i, this))
            })), n
        }
        ...
        _classes: function(n) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++) i = l.classesElementLookup[t[s]] || x(), i = n.add ? x(x.unique(i.get().concat(n.element.get()))) : x(i.not(n.element).get()), l.classesElementLookup[t[s]] = i, o.push(t[s]), e && n.classes[t[s]] && o.push(n.classes[t[s]])
            }
            return n = x.extend({
        ...
        _on: function(n, o, t) {
            var l, a = this;
            "boolean" != typeof n && (t = o, o = n, n = !1), t ? (o = l = x(o), this.bindings = this.bindings.add(o)) : (t = o, o = this.element, l = this.widget()), x.each(t, function(t, e) {
                function i() {
                    if (n || !0 !== a.options.disabled && !x(this).hasClass("ui-state-disabled")) return ("string" == typeof e ? a[e] : e).apply(a, arguments)
                }
        ...
        x.Widget.prototype["_" + o] = function(e, t, i) {
            ...
            var n = t ? !0 !== t && "number" != typeof t && t.effect || l : o;
            "number" == typeof(t = t || {}) && (t = {
                duration: t
    ...
    C = Math.max, E = Math.abs, o = /left|center|right/, l = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, h = /%$/, k = x.fn.position, x.position = {
        ...
        return g[0].preventDefault && (c.at = "left top"), f = e.width, m = e.height, p = e.offset, v = x.extend({}, p), x.each(["my", "at"], function() {
            var t, e, i = (c[this] || "").split(" ");
            1 === i.length && (i = o.test(i[0]) ? i.concat(["center"]) : l.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = o.test(i[0]) ? i[0] : "center", i[1] = l.test(i[1]) ? i[1] : "center", t = r.exec(i[0]), e = r.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], c[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]
            ...
            var i, t, l = x(this),
                ...
                e = W(this, "marginLeft"),
                s = W(this, "marginTop"),
                n = a + e + W(this, "marginRight") + y.width,
                o = r + s + W(this, "marginBottom") + y.height,
                u = x.extend({}, v),
                h = T(w.my, l.outerWidth(), l.outerHeight());
            "right" === c.my[0] ? u.left -= a : "center" === c.my[0] && (u.left -= a / 2), "bottom" === c.my[1] ? u.top -= r : "center" === c.my[1] && (u.top -= r / 2), u.left += h[0], u.top += h[1], i = {
                marginLeft: e,
                marginTop: s
                ...
                f < a && E(e + i) < f && (o.horizontal = "center"), m < r && E(s + n) < m && (o.vertical = "middle"), C(E(e), E(i)) > C(E(s), E(n)) ? o.important = "horizontal" : o.important = "vertical", c.using.call(this, t, o)
            }), l.offset(x.extend(u, {
                using: t
            }))
        })
        ...
        fit: {
            left: function(t, e) {
                ...
                e.collisionWidth > n ? 0 < l && a <= 0 ? (i = t.left + l + e.collisionWidth - n - s, t.left += l - i) : t.left = !(0 < a && l <= 0) && a < l ? s + n - e.collisionWidth : s : 0 < l ? t.left += l : 0 < a ? t.left -= a : t.left = C(t.left - o, t.left)
            },
            top: function(t, e) {
                var i = e.within,
                ...
                e.collisionHeight > n ? 0 < l && a <= 0 ? (i = t.top + l + e.collisionHeight - n - s, t.top += l - i) : t.top = !(0 < a && l <= 0) && a < l ? s + n - e.collisionHeight : s : 0 < l ? t.top += l : 0 < a ? t.top -= a : t.top = C(t.top - o, t.top)
            }
        },
        flip: {
            left: function(t, e) {
                var i = e.within,
                    ...
                    l = -2 * e.offset[0];
                a < 0 ? ((s = t.left + u + i + l + e.collisionWidth - n - s) < 0 || s < E(a)) && (t.left += u + i + l) : 0 < r && (0 < (o = t.left - e.collisionPosition.marginLeft + u + i + l - o) || E(o) < r) && (t.left += u + i + l)
            },
            top: function(t, e) {
                var i = e.within,
                    ...
                    l = -2 * e.offset[1];
                a < 0 ? ((s = t.top + u + i + l + e.collisionHeight - n - s) < 0 || s < E(a)) && (t.top += u + i + l) : 0 < r && (0 < (o = t.top - e.collisionPosition.marginTop + u + i + l - o) || E(o) < r) && (t.top += u + i + l)
            }
        },
        flipfit: {
            left: function() {
    ...
    x.widget("ui.autocomplete", {
        ...
        _suggest: function(t) {
            ...
            this._renderMenu(e, t), this.isNewMenu = !0, this.menu.refresh(), e.show(), this._resizeMenu(), e.position(x.extend({ of: this.element
